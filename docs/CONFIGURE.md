...
| rdioscannerServer       |          |                   | string                                                      | The URL for uploading to Rdio Scanner. The default is an empty string. It should be the same URL as the one you are using to access Rdio Scanner. |
...
| rdioscannerApiKey      |          |                                | string                                                       | [*if rdioscannerServer is set*] System-specific API key for uploading calls to Rdio Scanner. See the ApiKey section in the Rdio Scanner administrative dashboard for the value it should be. |
| rdioscannerSystemId    |          |                                | number                                                       | [*if rdioscannerServer is set*] System ID for Rdio Scanner. |
