...
void Call::end_call() {
    char shell_command[200];
            ...
            if (state == closing) {
                ...
                BOOST_LOG_TRIVIAL(info) << "\tRemoving Recorded Call \tTG: " << this->get_talkgroup() << "\tLast Update: " << this->since_last_update() << " Call Elapsed: " << this->elapsed() << " Closing Elapsed: " << this->closing_elapsed() << std::endl;
