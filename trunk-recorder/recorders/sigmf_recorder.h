...
public:
  ...
  virtual bool start(System *sys, Config *config) = 0;
  virtual void stop() = 0;
  ...
  virtual void increment_active_cycles() = 0;
  virtual long get_active_cycles() = 0;
  virtual void increment_idle_cycles() = 0;
  virtual long get_idle_cycles() = 0;
  virtual void reset_idle_cycles() = 0;
