...
public:
  ...
  virtual int parse_config(boost::property_tree::ptree &cfg )  { BOOST_LOG_TRIVIAL(info) << "plugin_api parse_config"; return 0;}; //const { BOOST_LOG_TRIVIAL(info) << "plugin_api created!";return 0; };
  ...
  virtual int call_end(Call_Data_t call_info) {  BOOST_LOG_TRIVIAL(info) << "plugin_api "; return 0;}; //= 0; //{ BOOST_LOG_TRIVIAL(info) << "plugin_api call_end"; return 0; };
  ...
  //virtual std::string name() const{ return 0;};
