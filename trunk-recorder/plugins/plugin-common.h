...
struct plugin_t {
    ...
    int (*audio_stream)(plugin_t * const plugin, int rec_num, float *samples, int sampleCount);
    ...
    int (*setup_recorders)(plugin_t * const plugin, std::vector<Recorder *> recorders);
