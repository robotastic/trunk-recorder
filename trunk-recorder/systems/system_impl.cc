...
int System_impl::set_channel_file(std::string channel_file, bool strict_parsing) {
  BOOST_LOG_TRIVIAL(info) << "Loading Talkgroups...";
  this->channel_file = channel_file;
  return this->talkgroups->load_channels(channel_file, strict_parsing);
}
...
int System_impl::set_talkgroups_file(std::string talkgroups_file, bool strict_parsing) {
  BOOST_LOG_TRIVIAL(info) << "Loading Talkgroups...";
  this->talkgroups_file = talkgroups_file;
  return this->talkgroups->load_talkgroups(talkgroups_file, strict_parsing);
}
